...
<title>CarFind | My Feedback</title>
    ...
    <div class="row">
      ...
      <div class="col-md-8 col-sm-8">
        ...
        <div class="profile_wrap">
          <h5 class="uppercase">My Feedback </h5>
          <div class="my_vehicles_list">
            <ul class="vehicle_listing">
<?php 
$userid=$_SESSION['id'];
$sql1 = "SELECT * from tblfeedback where userId='$userid'";
...
{ ?>
              ...
              <li>
                ...
                <div>
                 <p style="color:black;font-size:20px"><b><?php echo $row['text'];?></b>  </p>
                   <p>Posting Date : <?php echo $row['PostingDate'];?> </p>
                </div>
                <?php if($row['status']=='confirmed'){ ?>
                 <div class="vehicle_status"> <p style="color:green">Active <i class="fa fa-check"></i></p> </div>
                  <?php } elseif($row['status']=='pending') {?>
               <div class="vehicle_status"><p style="color:blue">Pending </p> </div>
                  <?php }else{?>
                <div class="vehicle_status"><p style="color:red">Canceled <i class="fa fa-close"></i> </p> </div>
                <?php  } ?>
              </li>
              <?php } } ?>
